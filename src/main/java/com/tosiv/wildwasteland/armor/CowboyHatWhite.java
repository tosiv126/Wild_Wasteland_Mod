...
public class CowboyHatWhite extends ArmorBaseModel {

    public CowboyHatWhite() {
        super(64,64, new ResourceLocation(WildWastelandMod.MOD_ID + ":textures/models/armor/cowboyhatwhitemodel.png"));
    }
