...
public class CowboyHatBlack extends ArmorBaseModel {

    public CowboyHatBlack() {
        super(64,64, new ResourceLocation(WildWastelandMod.MOD_ID + ":textures/models/armor/cowboyhatblackmodel.png"));
    }
